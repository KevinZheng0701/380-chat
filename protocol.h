...
void encryptMsg(const char *shared_file, const char *hmacfile, const char *public, const char *private, const char unsigned *msg, unsigned char *out, unsigned char *sessionID);
